package wolfboyft.magicalmages.entity.misc.render;
...
public class EntityRender extends RenderLiving {
	...
	public EntityRender(ModelBase model, float shadow, ResourceLocation tex) {
		super(Minecraft.getMinecraft().getRenderManager(), model, shadow);
		texture = tex;
	}

	public EntityRender(ModelBase model, ResourceLocation tex) {
		this(model, 0.5F, tex);
	}
