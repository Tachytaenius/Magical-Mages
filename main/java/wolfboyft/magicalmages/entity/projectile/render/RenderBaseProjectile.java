...
public class RenderBaseProjectile extends Render {
    ...
    public RenderBaseProjectile(ResourceLocation par1, float red, float green, float blue) {
    ...
    public RenderBaseProjectile(ResourceLocation par1, float scaleFactor, float red, float green, float blue) {
    	super(Minecraft.getMinecraft().getRenderManager());
        texture = par1;
        scale = scaleFactor;
        this.red = red;
