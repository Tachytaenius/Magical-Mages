package wolfboyft.magicalmages.entity.projectile.render;
...
public class RenderBaseProjectile extends Render {

	public ResourceLocation texture;
	private float scale, red, green, blue;

	public RenderBaseProjectile(ResourceLocation par1, float red, float green,
			float blue) {
	...
	public RenderBaseProjectile(ResourceLocation par1, float scaleFactor,
	...
	public void renderProjectile(EntityThrowable projectile, double x,
			double y, double z) {
		GL11.glPushMatrix();
