package wolfboyft.magicalmages.entity.mob.boss.render.layer;
...
public class LayerHallowMasterAura implements LayerRenderer
{
    private static final ResourceLocation field_177217_a = new ResourceLocation("textures/entity/wither/wither_armor.png");
    private final RenderHallowMaster field_177215_b;
    private final ModelWither field_177216_c = new ModelWither(0.5F);
    private static final String __OBFID = "CL_00002406";

    public LayerHallowMasterAura(RenderHallowMaster renderHallowMaster)
    {
        this.field_177215_b = renderHallowMaster;
    }

    public void func_177214_a(HallowMaster p_177214_1_, float p_177214_2_, float p_177214_3_, float p_177214_4_, float p_177214_5_, float p_177214_6_, float p_177214_7_, float p_177214_8_)
    {
    ...
    {
        this.func_177214_a((HallowMaster)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
    }
}