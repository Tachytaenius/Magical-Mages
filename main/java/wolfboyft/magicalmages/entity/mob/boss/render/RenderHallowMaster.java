...
public class RenderHallowMaster extends RenderLiving {
	private static final ResourceLocation invulnerableWitherTextures = new ResourceLocation(
			"magicalmages:textures/entity/hallow/witherHallow/witherHallow_invulnerable.png");
	private static final ResourceLocation witherTextures = new ResourceLocation(
			"magicalmages:textures/entity/hallow/witherHallow/witherHallow.png");
	...
	public void func_180591_a(HallowMaster p_180591_1_, double p_180591_2_,
			double p_180591_4_, double p_180591_6_, float p_180591_8_,
			float p_180591_9_) {
		BossStatus.setBossStatus(p_180591_1_, true);
		super.doRender((EntityLiving) p_180591_1_, p_180591_2_, p_180591_4_,
				p_180591_6_, p_180591_8_, p_180591_9_);
	}

	protected ResourceLocation getEntityTexture(HallowMaster entity) {
		int i = entity.getInvulTime();
		return i > 0 && (i > 80 || i / 5 % 2 != 1) ? invulnerableWitherTextures
				: witherTextures;
	}
	...
	public void doRender(EntityLiving entity, double x, double y, double z,
		...
		this.func_180591_a((HallowMaster) entity, x, y, z, p_76986_8_,
				partialTicks);
	}
