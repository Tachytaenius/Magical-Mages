...
public class HallowMaster extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else if (source != DamageSource.drown && !(source.getEntity() instanceof HallowMaster))
        {
