...
public class LayerHeldBlockFarlanderman implements LayerRenderer {
	private final RenderFarlanderman field_177174_a;
	private static final String __OBFID = "CL_00002424";

	public LayerHeldBlockFarlanderman(RenderFarlanderman renderFarlanderman) {
		this.field_177174_a = renderFarlanderman;
	}

	public void func_177173_a(Farlanderman p_177173_1_, float p_177173_2_,
			float p_177173_3_, float p_177173_4_, float p_177173_5_,
			float p_177173_6_, float p_177173_7_, float p_177173_8_) {
	...
	public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_,
		...
		this.func_177173_a((Farlanderman) p_177141_1_, p_177141_2_,
