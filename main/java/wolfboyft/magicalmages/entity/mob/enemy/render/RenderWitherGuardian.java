...
public class RenderWitherGuardian extends RenderLiving {
	private static final ResourceLocation field_177114_e = new ResourceLocation(
			"magicalmages:textures/entity/wither/guardian/main.png");
	private static final ResourceLocation field_177116_j = new ResourceLocation(
			"magicalmages:textures/entity/wither/guardian/elder.png");
	private static final ResourceLocation field_177117_k = new ResourceLocation(
			"magicalmages:textures/entity/wither/guardian/beam.png");
	int field_177115_a;
	...
	public boolean shouldRenderGuardian(WitherGuardian entity,
			ICamera p_177113_2_, double p_177113_3_, double p_177113_5_,
			double p_177113_7_) {
		if (super.shouldRenderLiving(entity, p_177113_2_, p_177113_3_,
				p_177113_5_, p_177113_7_)) {
			return true;
		} else {
			if (entity.func_175474_cn()) {
				...
				if (entitylivingbase != null) {
					Vec3 vec3 = this.func_177110_a(entitylivingbase,
							(double) entitylivingbase.height * 0.5D, 1.0F);
					Vec3 vec31 = this.func_177110_a(entity,
							(double) entity.getEyeHeight(), 1.0F);

					if (p_177113_2_.isBoundingBoxInFrustum(AxisAlignedBB
							.fromBounds(vec31.xCoord, vec31.yCoord,
									vec31.zCoord, vec3.xCoord, vec3.yCoord,
									vec3.zCoord))) {
						return true;
					}
				}
	...
	private Vec3 func_177110_a(EntityLivingBase p_177110_1_,
			double p_177110_2_, float p_177110_4_) {
		double d1 = p_177110_1_.lastTickPosX
				+ (p_177110_1_.posX - p_177110_1_.lastTickPosX)
				* (double) p_177110_4_;
		double d2 = p_177110_2_ + p_177110_1_.lastTickPosY
				+ (p_177110_1_.posY - p_177110_1_.lastTickPosY)
				* (double) p_177110_4_;
		double d3 = p_177110_1_.lastTickPosZ
				+ (p_177110_1_.posZ - p_177110_1_.lastTickPosZ)
				* (double) p_177110_4_;
	...
	public void func_177109_a(WitherGuardian p_177109_1_, double p_177109_2_,
		...
		super.doRender((EntityLiving) p_177109_1_, p_177109_2_, p_177109_4_,
				p_177109_6_, p_177109_8_, p_177109_9_);
		...
		if (entitylivingbase != null) {
			...
			float f4 = (float) p_177109_1_.worldObj.getTotalWorldTime()
					+ p_177109_9_;
			float f5 = f4 * 0.5F % 1.0F;
			float f6 = p_177109_1_.getEyeHeight();
			GlStateManager.pushMatrix();
			GlStateManager.translate((float) p_177109_2_, (float) p_177109_4_
					+ f6, (float) p_177109_6_);
			Vec3 vec3 = this.func_177110_a(entitylivingbase,
					(double) entitylivingbase.height * 0.5D, p_177109_9_);
			Vec3 vec31 = this.func_177110_a(p_177109_1_, (double) f6,
					p_177109_9_);
			...
			GlStateManager.rotate((((float) Math.PI / 2F) + -f8)
					* (180F / (float) Math.PI), 0.0F, 1.0F, 0.0F);
			GlStateManager.rotate(f7 * (180F / (float) Math.PI), 1.0F, 0.0F,
					0.0F);
			byte b0 = 1;
			double d4 = (double) f4 * 0.05D * (1.0D - (double) (b0 & 1) * 2.5D);
			worldrenderer.startDrawingQuads();
			float f9 = f2 * f2;
			worldrenderer.setColorRGBA(64 + (int) (f9 * 240.0F),
					32 + (int) (f9 * 192.0F), 128 - (int) (f9 * 64.0F), 255);
	...
	protected void func_177112_a(WitherGuardian p_177112_1_, float p_177112_2_) {
		if (p_177112_1_.isElder()) {
			GlStateManager.scale(2.35F, 2.35F, 2.35F);
		}
	}

	protected ResourceLocation func_177111_a(WitherGuardian p_177111_1_) {
	...
	public void doRender(EntityLiving entity, double x, double y, double z,
		...
		this.func_177109_a((WitherGuardian) entity, x, y, z, p_76986_8_,
				partialTicks);
	}

	public boolean shouldRenderLiving(EntityLiving p_177104_1_,
			ICamera p_177104_2_, double p_177104_3_, double p_177104_5_,
			double p_177104_7_) {
		return this.shouldRenderGuardian((WitherGuardian) p_177104_1_,
				p_177104_2_, p_177104_3_, p_177104_5_, p_177104_7_);
	}

	protected void preRenderCallback(EntityLivingBase p_77041_1_,
			float p_77041_2_) {
		this.func_177112_a((WitherGuardian) p_77041_1_, p_77041_2_);
	}
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return this.func_177111_a((WitherGuardian) entity);
	}
	...
	public boolean shouldRender(Entity entity, ICamera camera, double camX,
			double camY, double camZ) {
		return this.shouldRenderGuardian((WitherGuardian) entity, camera, camX,
				camY, camZ);
	}
}